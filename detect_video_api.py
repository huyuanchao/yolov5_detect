...
DETECTION_URL = "/v1/object-detection/road_detection"
...
def detect():
    ...
    weight='/home/work/project/yolov5/road_detection.pt'

    # Directories
    save_dir = increment_path(Path(opt.project) / opt.name, exist_ok=opt.exist_ok)  # increment run
    (save_dir / 'labels' if save_txt else save_dir).mkdir(parents=True, exist_ok=True)  # make dir
    filename="road_cross_saved.mp4"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='road_detection.pt', help='model.pt path(s)')
